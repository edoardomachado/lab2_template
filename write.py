...
def write_instructors():
    ...
    # Update the user referrence of instructor_john to be user_john
...
def write_courses():
    # Add Courses
    course_cloud_app = Course(name='Cloud Application Development with Databse',
                              description='Develop and deploy application on cloud')
    course_cloud_app.save()

    course_python = Course(name='Introduction to Python',
                              description="Learn core conceptos of Python and obtain hands-on "
...
def write_learners():
    ...
    print("Learner object all saved.")
